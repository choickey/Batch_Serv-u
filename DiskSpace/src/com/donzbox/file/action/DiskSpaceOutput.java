...
public class DiskSpaceOutput  {
  ...
  /*범례	
    +-------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
    |Size(T)|  9.99  |  3.00  |  2.00  |  1.50  |  1.00  |  0.50  |  0.32  |  0.30  |  0.08  |
    +-------+--------+--------+--------+--------+--------+--------+--------+--------+--------+
    | Float | 0.0013 | 0.0045 | 0.0050 | 0.0064 | 0.0080 | 0.0130 | 0.0140 | 0.0150 | 0.0350 |
    +-------+--------+--------+--------+--------+--------+--------+--------+--------+--------+*/
	private static float ctrlFloat_A = 0.0300f; // 0.30 T
	private static float ctrlFloat_D = 0.0045f; // 3.00 T
	...
	private static float ctrlFloat_H = 0.0013f; // 9.99 T
...
//		list.add("D69)");
		...
		list.add(DRIVE_D + " ⇒ 하드디스크 인식불가 (ㅠ_ㅠ)");
		list.add(DRIVE_E + " ⇒  하드디스크 인식불가 (ㅠ_ㅠ)");
		list.add(DRIVE_F + " ⇒  하드디스크 인식불가 (ㅠ_ㅠ)");
		list.add(DRIVE_G + " ⇒  하드디스크 인식불가 (ㅠ_ㅠ)");
		list.add(DRIVE_H + " ⇒  하드디스크 인식불가 (ㅠ_ㅠ)");
		list.add(DRIVE_I + " ⇒  하드디스크 인식불가 (ㅠ_ㅠ)");
		list.add(DRIVE_J + " ⇒  하드디스크 인식불가 (ㅠ_ㅠ)");
		list.add("D90)  ￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣");
